...
style.configure("TButton", background=BTN_BG, foreground=BTN_FG, font=("Segoe UI", 10), padding=6)
style.configure("TEntry", fieldbackground=ENTRY_BG, foreground=FG_COLOR)
style.configure("TNotebook", background=BG_COLOR)
style.configure("TNotebook.Tab", background="#dddddd", foreground="#000000", padding=6)
...
ttk.Label(tab_binder, text="Supported: .jpg .png .pdf .docx .mp3 .mp4 .exe .apk", foreground="#666666").pack()
...
ttk.Label(tab_exit, text="Developed by: Dark Soham", foreground="#888888", font=("Segoe UI", 9)).pack(pady=5)
